...
class MjyySpider(scrapy.Spider):
	...
	def detail_parse(self,response):
		...
		item['tv_img']=response.xpath('//div[@class="vodImg"]/img/@src')[0].extract()
		item['tv_name']=response.xpath('//div[@class="vodInfo"]//h2/text()')[0].extract()
		try:
		...
		item['tv_type']=response.xpath('//div[@class="vodInfo"]//div[@class="vodinfobox"]//li[4]/span/text()')[0].extract()
		try:
