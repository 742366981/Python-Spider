...
class MjyySpider(scrapy.Spider):
	...
	start_urls = ['http://www.ziyuanpian.com/?m=vod-type-id-4-pg-1.html']
	url='http://www.ziyuanpian.com/?m=vod-type-id-4-pg-{}.html'
	page=1
	...
	def detail_parse(self,response):
		...
		item['animation_img']=response.xpath('//div[@class="vodImg"]/img/@src')[0].extract()
		item['animation_name']=response.xpath('//div[@class="vodInfo"]//h2/text()')[0].extract()
		...
		item['animation_type']=response.xpath('//div[@class="vodInfo"]//div[@class="vodinfobox"]//li[4]/span/text()')[0].extract()
		try:
